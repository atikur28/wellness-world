const WhyChooseUs = () => {
    return (
        <div className="w-11/12 mx-auto py-14 mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mx-10 text-center my-10">
                <div className="border rounded-md py-10 bg-white" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
